...
} from '../../lib/redux/actions/basketActions';
import { updateValidityAll, UpdateValidityAllType } from '../../lib/redux/actions/checkoutFormActions';

// Functions
import { validateAll } from '../../lib/validate';
import { sendOrder, checkSwishStatus } from '../../lib/apiCalls';
import { addItemToBasketGaEvent, removeItemFromBasketGaEvent, purchaseGaEvent } from '../../lib/gaEcommerce';
...
function Basket(props: Props) {
  ...
  const handleChange = (
    ...
    const value = action === 'update' ? event.currentTarget.value : '0';
    const payload = {
